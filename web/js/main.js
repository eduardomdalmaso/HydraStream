...
import { openONVIFModal, closeONVIFModal, handleONVIFScan, handleManualProbe } from './components/onvif_modal.js?v=1.0.2';
...
window.openONVIFModal = openONVIFModal;
window.closeONVIFModal = closeONVIFModal;
window.handleONVIFScan = handleONVIFScan;
window.handleManualProbe = handleManualProbe;
